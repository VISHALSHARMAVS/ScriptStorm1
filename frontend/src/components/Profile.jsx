...
function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`https://scriptstorm1.onrender.com/api/v1/user/update/${currentUser._id}`, formData, { withCredentials: true });
      const data = res.data;
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await axios.delete(`https://scriptstorm1.onrender.com/api/v1/user/delete/${currentUser._id}` ,  { withCredentials: true })
