...
function Users() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
          try {
            const res = await axios.get(`http://localhost:3000/api/v1/user/getusers`,{withCredentials:true});
      ...
      const handleShowMore = async () => {
        ...
        try {
          const res = await axios.get(`http://localhost:3000/api/v1/user/getusers?startIndex=${startIndex}`,{withCredentials:true});
          const data = await res.data;
        ...
        const handleDeleteUser = async () => {
            try {
                const res = await axios.delete(`http://localhost:3000/api/v1/user/delete/${userIdToDelete}`, {withCredentials:true});
                const data =  res.data;
                if (data) {
