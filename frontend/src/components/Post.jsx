...
export default function Post() {
    ...
    const fetchPosts = async () => {
      try {
        const res = await axios.get(
          `https://scriptstorm-47.onrender.com/api/v1/post/getposts?userId=${currentUser._id}`
        );
        const data = res.data;
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await axios.get(
        `https://scriptstorm-47.onrender.com/api/v1/post/getposts?userId=${currentUser._id}&startIndex=${startIndex}`,
  ...
  const handleDeletePost = async () => {
    ...
    try {
      const res = await axios.delete(
        `https://scriptstorm-47.onrender.com/api/v1/post/deletepost/${postIdToDelete}/${currentUser._id}`,
        { withCredentials: true }
      );
      const data = res.data;
      if (!data) {
