...
export default function DashboardComp() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await axios.get('api/v1/user/getusers?limit=5',{withCredentials:true});
    ...
    const fetchComments = async () => {
      try {
        const res = await axios.get('api/v1/comment/getcomments?limit=5',{withCredentials:true});
